...
// 輸出bmi歷史資料(bmiHistoryData)，並算出計算次數，以及最後一筆資料的內容
function showHistoryData(){
    let bmiNum = bmiHistoryData.length;
    let lastNam = bmiNum - 1;
    let lastBmi = bmiHistoryData[lastNam].bmi;
    let lastState = bmiHistoryData[lastNam].state;
